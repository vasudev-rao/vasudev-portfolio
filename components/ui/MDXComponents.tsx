...
export const MDXComponents: MDXComponents = {
  h1: ({ children }) => (
    <h1 className="text-3xl font-bold dark:text-white text-gray-900 mt-10 mb-4 leading-tight tracking-tight">{children}</h1>
  ),
  h2: ({ children }) => (
    <h2 className="text-2xl font-bold dark:text-white text-gray-900 mt-8 mb-3 leading-tight pb-2 border-b dark:border-white/[0.07] border-black/[0.07]">{children}</h2>
  ),
  h3: ({ children }) => (
    <h3 className="text-lg font-semibold dark:text-white text-gray-900 mt-6 mb-2">{children}</h3>
  ),
  p: ({ children }) => (
    <p className="dark:text-gray-400 text-gray-500 leading-relaxed mb-4">{children}</p>
  ),
  a: ({ href, children }) => (
  ...
  ul: ({ children }) => (
    <ul className="list-disc list-inside dark:text-gray-400 text-gray-500 space-y-1.5 mb-4 pl-2">{children}</ul>
  ),
  ol: ({ children }) => (
    <ol className="list-decimal list-inside dark:text-gray-400 text-gray-500 space-y-1.5 mb-4 pl-2">{children}</ol>
  ),
  li: ({ children }) => (
    <li className="dark:text-gray-400 text-gray-500 leading-relaxed">{children}</li>
  ),
  blockquote: ({ children }) => (
  ...
  hr: () => <hr className="my-8 dark:border-white/[0.07] border-black/[0.07]" />,
  strong: ({ children }) => (
  ...
  td: ({ children }) => (
    <td className="px-4 py-3 border-b dark:border-white/[0.04] border-black/[0.04]">{children}</td>
  ),
}
